...
void menuDocente(){
    ...
    while(opcion != '9'){
        ...
        switch(opcion){
            ...
            case '6':
            case '7':
            case '8': cout << "To be inputted" << endl; cin.get(); cin.ignore(); break;
            case '9': cout << "Salida del menu" << endl; cin.get(); cin.ignore(); break;
            default: cout << "El caracter introducido no es valido. Introduzca un numero del 0-9" << endl; cin.get(); cin.ignore(); 
        }
        system("cls");
    }   
}
